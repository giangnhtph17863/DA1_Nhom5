...
import Service.IQLNVService;
import Service.QLNVService;
...
public class form_quanli_MainFormQLNhanVien extends javax.swing.JFrame {
    ...
    private final IQLNVService iQlnvService;
    ...
    private void fillToTable() {
        List<NhanVien> ds = iQlnvService.getQuanLyNV(currentPage - 1, pageSize);
        ...
        totalNv = iQlnvService.countAllNv();
        lbTotalNv.setText("Total: " + totalNv);
        totalPages = (int) (totalNv / pageSize) + 1;
        setStatePagination();
    }
...
//    }
    ...
    public boolean checkTrungMa(JTextField txt) {
        txt.setBackground(white);
        if (iQlnvRepository.findByMaNv(txt.getText()) == null) {
            return true;
        } else {
            txt.setBackground(pink);
            XCheck.alert(this, txt.getName() + " đã tồn tại.");
            return false;
        }
    }
    ...
    void edit() {
        ...
        try {
            ...
            NhanVien nv = iQlnvRepository.findByMaNv(manv); //dùng maNV tìm ra đối tượng nhanVien
            if (nv != null) {
    ...
    void insert() {
        ...
        NhanVien nv = getForm();
        try {
            iQlnvService.createNewNv(nv);
            this.fillToTable();    //cập nhật lại bảng nv
            this.clear();   // xóa trắng form
            XCheck.alert(this, "Thêm mới thành công!");
        } catch (Exception e) {
            XCheck.alert(this, "Thêm mới thất bại!");
        }
    }
    ...
    void update() {
        NhanVien nv = getForm();
        try {
            iQlnvService.updateNvByMaNV(nv);     //cập nhật nhân viên theo maNV
            this.fillToTable(); //điền tt mới vào bảng
            this.clear();
            XCheck.alert(this, "Cập nhật thành công!");
        } catch (Exception e) {
            XCheck.alert(this, "Cập nhật thất bại!");
        }
    }
    ...
    private void initComponents() {
        ...
        lbTotalNv = new javax.swing.JLabel();
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(54, 54, 54)
                        .addComponent(lbPagination, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(lbTotalNv, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(138, 138, 138))))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(lbTotalNv, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGap(5, 5, 5))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(lbPagination, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap())
        );
    ...
    private void btnTimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimKiemActionPerformed
        ...
        NhanVien nv = iQlnvRepository.findByMaNv(timkiem);
        if (nv != null) {
            setForm(nv);
            XCheck.alert(this, "Đã tìm thấy");
        } else if (nv == null) {
            XCheck.alert(this, "Không có nhân viên bạn cần tìm");
        }
    ...
    private javax.swing.JLabel lbTotalNv;
